...
export interface ImportPathGroup {
  pattern: string;
  group: "builtin" | "external" | "internal" | "parent" | "sibling" | "index";
  position?: "before" | "after";
}

export interface MiddenConfigOptions {
  pathGroups?: ImportPathGroup[];
}

export default function coreConfig(options: MiddenConfigOptions = {}) {
